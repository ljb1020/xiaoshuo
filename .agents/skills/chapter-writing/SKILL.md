...
### 5. Censorship Linter (CRITICAL)

Before saving the final chapter text, you MUST perform a keyword scan to ensure web-novel compliance. Check the text against the censorship constraints in `story.md` (e.g., replacing 中国 with 龙国, 日本 with 樱花国, 055 with 0VV). If any violations are found, perform a string replacement before saving.
